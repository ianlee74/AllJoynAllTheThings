...
void FezHatProducer::CallSetRedLedStateHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        FezHatSetRedLedStateResult^ result = create_task(producer->Service->SetRedLedStateAsync(callInfo, inputArg0)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void FezHatProducer::CallGetRedLedStateHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        FezHatGetRedLedStateResult^ result = create_task(producer->Service->GetRedLedStateAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void FezHatProducer::CallSetRgbLedD2ColorHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        (void)TypeConversionHelpers::GetAllJoynMessageArg(alljoyn_message_getarg(message, 0), "b", &inputArg0);
        byte inputArg1;
        (void)TypeConversionHelpers::GetAllJoynMessageArg(alljoyn_message_getarg(message, 1), "y", &inputArg1);
        byte inputArg2;
        (void)TypeConversionHelpers::GetAllJoynMessageArg(alljoyn_message_getarg(message, 2), "y", &inputArg2);
        byte inputArg3;
        (void)TypeConversionHelpers::GetAllJoynMessageArg(alljoyn_message_getarg(message, 3), "y", &inputArg3);

        FezHatSetRgbLedD2ColorResult^ result = create_task(producer->Service->SetRgbLedD2ColorAsync(callInfo, inputArg0, inputArg1, inputArg2, inputArg3)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void FezHatProducer::CallSetRgbLedD3ColorHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        FezHatSetRgbLedD3ColorResult^ result = create_task(producer->Service->SetRgbLedD3ColorAsync(callInfo, inputArg0, inputArg1, inputArg2, inputArg3)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void FezHatProducer::CallGetLightSensorValueHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        FezHatGetLightSensorValueResult^ result = create_task(producer->Service->GetLightSensorValueAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void FezHatProducer::CallGetTemperatureSensorValueHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        FezHatGetTemperatureSensorValueResult^ result = create_task(producer->Service->GetTemperatureSensorValueAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
