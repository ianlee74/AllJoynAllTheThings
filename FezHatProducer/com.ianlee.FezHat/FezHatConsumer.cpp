...
IAsyncOperation<FezHatSetRedLedStateResult^>^ FezHatConsumer::SetRedLedStateAsync(_In_ bool interfaceMemberOn)
{
    return create_async([this, interfaceMemberOn]() -> FezHatSetRedLedStateResult^
    {
        ...
        status = static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "b", interfaceMemberOn));
...
IAsyncOperation<FezHatGetRedLedStateResult^>^ FezHatConsumer::GetRedLedStateAsync()
{
    return create_async([this]() -> FezHatGetRedLedStateResult^
    {
...
IAsyncOperation<FezHatSetRgbLedD2ColorResult^>^ FezHatConsumer::SetRgbLedD2ColorAsync(_In_ bool interfaceMemberOn, _In_ byte interfaceMemberRed, _In_ byte interfaceMemberGreen, _In_ byte interfaceMemberBlue)
{
    return create_async([this, interfaceMemberOn, interfaceMemberRed, interfaceMemberGreen, interfaceMemberBlue]() -> FezHatSetRgbLedD2ColorResult^
    {
        ...
        if (ER_OK == status)
        {
            status = static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 1), "y", interfaceMemberRed));
        }
	
        if (ER_OK == status)
        {
            status = static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 2), "y", interfaceMemberGreen));
        }
	
        if (ER_OK == status)
        {
            status = static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 3), "y", interfaceMemberBlue));
        }
...
IAsyncOperation<FezHatSetRgbLedD3ColorResult^>^ FezHatConsumer::SetRgbLedD3ColorAsync(_In_ bool interfaceMemberOn, _In_ byte interfaceMemberRed, _In_ byte interfaceMemberGreen, _In_ byte interfaceMemberBlue)
{
    return create_async([this, interfaceMemberOn, interfaceMemberRed, interfaceMemberGreen, interfaceMemberBlue]() -> FezHatSetRgbLedD3ColorResult^
    {
...
IAsyncOperation<FezHatGetLightSensorValueResult^>^ FezHatConsumer::GetLightSensorValueAsync()
{
    return create_async([this]() -> FezHatGetLightSensorValueResult^
    {
...
IAsyncOperation<FezHatGetTemperatureSensorValueResult^>^ FezHatConsumer::GetTemperatureSensorValueAsync()
{
    return create_async([this]() -> FezHatGetTemperatureSensorValueResult^
    {
...
void FezHatConsumer::CallButtonDio18PressedSignalHandler(_In_ const alljoyn_interfacedescription_member* member, _In_ alljoyn_message message)
{
    ...
    auto consumer = source->second->Resolve<FezHatConsumer>();
...
void FezHatConsumer::CallButtonDio22PressedSignalHandler(_In_ const alljoyn_interfacedescription_member* member, _In_ alljoyn_message message)
{
    auto source = SourceInterfaces.find(member->iface);
    if (source == SourceInterfaces.end())
    {
